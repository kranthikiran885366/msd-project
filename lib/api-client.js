...
class APIClient {
  ...
  async updateProfile(nameOrPayload, avatar) {
    const payload = typeof nameOrPayload === "object"
      ? nameOrPayload
      : { name: nameOrPayload, avatar }
  ...
  async getRepos() {
    return this.getGitHubRepositories()
  }
  ...
  async redeployDeployment(id) {
    return this.request(`/deployments/${id}/redeploy`, { method: 'POST' })
  }

  async rebuildDeployment(id) {
    return this.request(`/deployments/${id}/rebuild`, { method: 'POST' })
  }

  async cancelDeployment(id) {
    return this.request(`/deployments/${id}/cancel`, { method: 'POST' })
  }
  ...
  async restartDatabase(id) {
    return this.request(`/databases/${id}/restart`, { method: "POST" })
  }

  async pauseDatabase(id) {
    return this.request(`/databases/${id}/pause`, { method: "POST" })
  }
  ...
  async getDomainVerificationStatus(id) {
    return this.request(`/domains/${id}/verification-status`)
  }

  async regenerateDomainVerification(id) {
    return this.request(`/domains/${id}/regenerate-verification`, { method: 'POST' })
  }

  async assignDomainToDeployment(deploymentId, domainId) {
    return this.request(`/deployments/${deploymentId}/assign-domain`, { method: 'POST', body: JSON.stringify({ domainId }) })
  }
  ...
  async createDeploymentJob(data) {
  ...
  async getNodeStats() {
    return this.request('/nodes/stats')
  }
  ...
  async getTeamRoles(projectId) {
    return this.request(`/team/${projectId}/roles`)
  }

  async getTeamStats(projectId) {
    return this.request(`/team/${projectId}/stats`)
  }

  async getTeamActivityLogs(options = {}) {
    const query = new URLSearchParams(options).toString()
    return this.request(`/team/activity-logs${query ? `?${query}` : ''}`)
  }

  async getUserActivity(userId, limit = 50) {
    const query = new URLSearchParams({ userId, limit }).toString()
    return this.request(`/team/user-activity?${query}`)
  }

  async getTeamInvitations(projectId) {
    return this.request(`/team/invitations/pending/${projectId}`)
  }
  ...
  async resendInvitation(invitationId) {
    return this.request(`/team/invitations/${invitationId}/resend`, { method: 'POST' })
  }

  async cancelInvitation(invitationId) {
    return this.request(`/team/invitations/${invitationId}/revoke`, { method: 'POST' })
  }
  ...
  async getBuilds(projectId, options = {}) {
    const query = new URLSearchParams(options).toString()
    return this.request(`/builds/${projectId}${query ? `?${query}` : ""}`)
  }

  async createBuild(projectId, data) {
    return this.request(`/builds/${projectId}`, {
      method: "POST",
      body: JSON.stringify(data),
    })
  }
  ...
  async getBuildLogs(projectId, buildId) {
    return this.request(`/builds/${projectId}/${buildId}/logs`)
  }

  async retryBuild(projectId, buildId) {
    return this.request(`/builds/${projectId}/${buildId}/retry`, {
      method: "POST",
    })
  }

  async cancelBuild(projectId, buildId, reason) {
    return this.request(`/builds/${projectId}/${buildId}/cancel`, {
      method: "POST",
  ...
  async getBuildAnalytics(projectId, timeRange = 7) {
    return this.request(`/builds/${projectId}/analytics?timeRange=${timeRange}`)
  }
  ...
  // Billing Contacts
  async getBillingContacts(organizationId) {
    return this.request(`/team/billing-contacts/${organizationId}`)
  }

  async createBillingContact(organizationId, data) {
    return this.request(`/team/billing-contacts/${organizationId}`, {
      method: "POST",
      body: JSON.stringify(data)
    })
  ...
  async getBillingContactById(organizationId, id) {
    return this.request(`/team/billing-contacts/${organizationId}/${id}`)
  }

  async updateBillingContact(organizationId, id, data) {
    return this.request(`/team/billing-contacts/${organizationId}/${id}`, {
      method: "PUT",
      body: JSON.stringify(data)
    })
  ...
  async deleteBillingContact(organizationId, id) {
    return this.request(`/team/billing-contacts/${organizationId}/${id}`, {
      method: "DELETE"
    })
  }

  async setDefaultBillingContact(organizationId, id) {
    return this.request(`/team/billing-contacts/${organizationId}/${id}/primary`, {
      method: "POST"
    })
  }
  ...
  async getTeamGroups(teamId) {
    return this.request(`/team/groups/team/${teamId}`)
  }

  async getTeamGroup(groupId) {
    return this.request(`/team/groups/${groupId}`)
  }
  ...
  async updateTeamGroup(groupId, data) {
    return this.request(`/team/groups/${groupId}`, {
      method: "PUT",
      body: JSON.stringify(data)
    })
  ...
  async deleteTeamGroup(groupId) {
    return this.request(`/team/groups/${groupId}`, {
      method: "DELETE"
    })
  }

  async addTeamGroupMembers(groupId, memberIds) {
    return this.request(`/team/groups/${groupId}/members`, {
      method: "POST",
      body: JSON.stringify({ memberIds })
    })
  }

  async removeTeamGroupMembers(groupId, memberIds) {
    return this.request(`/team/groups/${groupId}/members`, {
      method: "DELETE",
      body: JSON.stringify({ memberIds })
    })
  ...
  async updateTeamGroupPermissions(groupId, permissions) {
    return this.request(`/team/groups/${groupId}/permissions`, {
      method: "PUT",
  ...
  async getAuditLogs(options = {}) {
    const query = new URLSearchParams(options).toString()
    return this.request(`/security/audit-logs${query ? `?${query}` : ''}`)
  }

  async getAuditLog(logId) {
    return this.request(`/security/audit-logs/${logId}`)
  }

  async archiveAuditLogs(before) {
    return this.request(`/security/audit-logs/archive`, {
      method: "POST",
  ...
  async getUptimeMetrics(projectId, timeRange = '30d') {
    return this.request(`/uptime/project/${projectId}/stats?timeRange=${timeRange}`)
  }
  ...
  async getSlaStatus(projectId) {
    return this.getSLAStatus(projectId)
  }
  ...
  async getIncidentHistory(projectId, timeRange = 30) {
    return this.request(`/uptime/project/${projectId}/incidents?timeRange=${timeRange}`)
  }
  ...
  async retryWebhookDelivery(webhookId, deliveryId) {
    return this.request(`/webhooks/${webhookId}/deliveries/${deliveryId}/retry`, {
      method: "POST"
    })
  }

  async getWebhookStatistics(webhookId, timeRange = 7) {
    return this.request(`/webhooks/${webhookId}/statistics?timeRange=${timeRange}`)
  }

  // Compatibility helpers for integration pages
  async createWebhookEndpoint(data) {
    const { projectId, eventTypes = [], ...rest } = data
    return this.createWebhook(projectId, { ...rest, events: eventTypes })
  }
  ...
  async testWebhookEndpoint(webhookId, payload = {}) {
    return this.testWebhookById(webhookId, payload)
  }

  async getWebhookEndpointLogs(webhookId, options = {}) {
    return this.getWebhookDeliveries(webhookId, options)
  }

  async createCustomIntegration(data) {
    const { projectId, endpoint, enabled = true, ...rest } = data
    return this.createWebhook(projectId, {
      ...rest,
      url: endpoint,
      active: enabled,
      events: rest.eventTypes || ["event.recorded"],
    })
  }

  async deleteCustomIntegration(id) {
    return this.deleteWebhook(id)
  }

  async testCustomIntegration(id, payload = {}) {
    return this.testWebhookById(id, payload)
  }

  async getCustomIntegrationLogs(id, options = {}) {
    return this.getWebhookDeliveries(id, options)
  }

  async createGatewayEndpoint(data) {
    const { projectId, targetUrl, authRequired, caching, ...rest } = data
    return this.createWebhook(projectId, {
      ...rest,
      url: targetUrl,
      active: true,
      events: ["event.recorded"],
      metadata: { authRequired, caching },
    })
  }

  async deleteGatewayEndpoint(id) {
    return this.deleteWebhook(id)
  }

  async configureRateLimiting(id, config = {}) {
    return this.updateWebhook(id, { metadata: { rateLimit: config.rateLimit } })
  }

  async exportIntegrationAnalytics(options = {}) {
    const query = new URLSearchParams(options).toString()
    return this.request(`/analytics/export/integrations${query ? `?${query}` : ""}`)
  }

  // API Tokens
  async getApiTokens(projectId) {
    const query = projectId ? `?projectId=${projectId}` : ""
    return this.request(`/api-tokens${query}`)
  }
  ...
  async getApiToken(tokenId) {
    return this.request(`/api-tokens/${tokenId}`)
  }

  async rotateApiToken(tokenId) {
    return this.request(`/api-tokens/${tokenId}/rotate`, {
      method: "PATCH"
    })
  }
  ...
  async deleteApiToken(tokenId) {
    return this.request(`/api-tokens/${tokenId}/delete`, {
      method: "DELETE"
    })
  }

  async getApiTokenUsage(tokenId, timeRange = 30) {
    return this.request(`/api-tokens/${tokenId}/usage?timeRange=${timeRange}`)
  }

  async getApiTokenStats(projectId, timeRange = 30) {
    return this.request(`/api-tokens/stats/${projectId}?timeRange=${timeRange}`)
  }

  async validateApiToken(token) {
    return this.request("/api-tokens/validate", {
      method: "POST",
  ...
  async testNotificationWebhook(endpoint) {
  ...
  async testWebhookById(webhookId, testData = {}) {
    return this.request(`/webhooks/${webhookId}/test`, {
      method: "POST",
      body: JSON.stringify(testData)
    })
  ...
  async setupDeploymentWebhook(projectId, owner, repo) {
    if (!projectId || !owner || !repo) {
      throw new Error('projectId, owner, and repo are required to configure deployment webhook')
    }
  ...
  async getDeploymentConfig(projectId) {
    ...
    const repository = project?.repository
      ? {
          ...
          fullName: project.repository.owner && project.repository.name
            ...
            : '',
          url: project.repository.owner && project.repository.name
            ? `https://github.com/${project.repository.owner}/${project.repository.name}`
            : '',
          defaultBranch: project.repository.branch || 'main',
    ...
    return {
      ...
      repository,
      autoDeployEnabled: project?.deploymentSettings?.autoDeploy ?? true,
      previewDeployEnabled: project?.deploymentSettings?.previewsEnabled ?? true,
      deploymentSettings: project?.deploymentSettings || {},
    }
  }
  ...
  async updateDeploymentSettings(projectId, settings) {
    const payload = {
      deploymentSettings: {
        autoDeploy: settings?.autoDeployEnabled,
        previewsEnabled: settings?.previewDeployEnabled,
      },
    }
