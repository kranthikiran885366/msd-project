...
const SOCKET_SERVER_URL = process.env.NEXT_PUBLIC_SOCKET_SERVER_URL || process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001';
...
class SocketService {
  ...
  connect() {
    ...
    this.socket = io(SOCKET_SERVER_URL, {
      ...
      auth: {
        token: typeof window !== 'undefined' ? (tokenService.getAccessToken() || localStorage.getItem('token')) : null,
      },
    });
